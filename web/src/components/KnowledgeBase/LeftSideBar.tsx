  ...
  return (
    <div className="k-left-container flex-flex-col gap-4 h-full">
      ...
      <div className="k-new-chat" onClick={() => setShowCreateModal(true)}>
        <button className="w-full  bg-indigo-500 text-white hover:bg-indigo-700 transition-colors rounded-full">新建知识库</button>
      </div>
      ...
      {showConfirmDeleteBase && (
        <ConfirmDialog
          message={`确认删除知识库 "${showConfirmDeleteBase.base.name}"吗？`}
